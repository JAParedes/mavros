...
void callbackPostSetpoints(const ros::TimerEvent& event)
{
	...
	static WP_Filter filt_x(0.0f,zeta_filt, wn_filt, sp_rate, max_vel_xyz_filt);
	static WP_Filter filt_y(0.0f,zeta_filt, wn_filt, sp_rate, max_vel_xyz_filt);
	static WP_Filter filt_z(0.0f,zeta_filt, wn_filt, sp_rate, max_vel_xyz_filt);
	static WP_Filter filt_yaw(0.0f,zeta_filt, wn_filt, sp_rate, max_vel_yaw_filt);
